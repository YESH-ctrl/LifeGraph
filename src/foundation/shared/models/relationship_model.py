...
class RelationshipModel:
    def __init__(self, source_type: str, source_id: str, target_type: str, target_id: str, relationship_type: str, **kwargs):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'RelationshipModel':
        ...
        metadata = {k: v for k, v in data.items() if k not in ['PK', 'SK', 'sourceType', 'sourceId', 'targetType', 'targetId', 'relationshipType']}
