...
from foundation.shared.repositories.user_repository import UserRepository
from foundation.shared.models.user_model import UserModel
from foundation.shared.schemas.user_schemas import UserCreate, UserUpdate
