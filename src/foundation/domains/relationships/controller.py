import json
from foundation.domains.relationships.service import RelationshipService
from foundation.domains.relationships.schemas import RelationshipCreate, RelationshipResponse
