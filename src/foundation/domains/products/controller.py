import json
from foundation.domains.products.service import ProductService
from foundation.domains.products.schemas import ProductCreate, ProductUpdate, ProductResponse
